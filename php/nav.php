...
<body>
    ...
    <div id="navSidebar" class="sidebarNav">
        ...
        <a href="./pacientes"><i class="fas fa-users"></i> Pacientes</a>
        <a href="./doctores"><i class="fas fa-user-md"></i> Doctores</a>
        <a href="./reportes"><i class="far fa-chart-bar"></i> Reportes</a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background: #51034f;">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <!--<li class="nav-item">
                        <a class="nav-link" href="./mensajes"><i class="fa fa-fw fa-envelope"></i> Mensajes</a>
                    </li>-->
                    <li class="nav-item">
                        <a class="nav-link" href="./calendario"><i class="far fa-calendar-alt"></i> Calendario</a>
                    </li>
                    <li class="nav-item">
