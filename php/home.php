...
<body onload="setUser(<?php echo $_SESSION['userID'] . ',' . $_SESSION['userType'] ?>)">
    <?php require $nav; ?>
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-interval="5000">
                <img src="../img/banner.jpg" class="d-block w-100" alt="Clinica-universitaria" id="img">
        ...
        <a id="prev" class="carousel-control-prev" href="#carouselExampleCaptions" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a id="next" class="carousel-control-next" href="#carouselExampleCaptions" role="button" data-slide="next">
    ...
    <div class="container">
        ...
        <div class="accordion mb-5" id="accordionExample">
            <div class="card">
                <div class="card-header" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" id="headingOne">
                    <h4 class="mb-0">
            ...
            <div class="card">
                <div class="card-header collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" id="headingTwo">
                    <h4 class="mb-0">
                        Objetivos
                    </h4>
                </div>
            ...
            <div class="card">
                <div class="card-header collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" id="headingThree">
                    <h4 class="mb-0">
                        Funciones
                    </h4>
                </div>
            ...
            <div class="card">
                <div class="card-header collapsed" id="headingFour" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    <h4 class="mb-0">
                        Servicios Ofertados
                    </h4>
                </div>
        ...
        <section class="mb-4">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-9 mb-md-0 mb-4">
                    <div class="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.478803914558!2d-79.53496485016481!3d9.020011391582784!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8faca83f2ef676e5%3A0x210e42b715ec286f!2sVicerrector%C3%ADa%20Administrativa%20Universidad%20Tecnol%C3%B3gica%20de%20Panam%C3%A1!5e0!3m2!1ses!2spa!4v1572377582358!5m2!1ses!2spa" width="600" height="1000" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
