                ...
                <div class="menu-calendario">
                    ...
                    <ul class="nav nav-tabs">
                        <div class="menuDesplegado" id="menuDesplegado" style="display:none;">
                            ...
                            <li>
                                <h6><a class="nav-link" href="./calendario-pacientes"><i
                                            class="far fa-calendar-alt"></i> Calendario</a></h6>
                            </li>
                            <li>
                        ...
                        <div class="calendar-footer">
                            ...
                            <div class="addForm" id="addForm">
                                ...
                                <div class="row">
                                    ...
                                    <!--AGREGAR HORA-->
                                    <div class="input-field col s6">
                                        <input id="eventDescInput" name="descripcion" type="text"
                                            placeholder="Descripción" class="validate">
                                    </div>

                                    <!--AGREGAR DOCTOR-->
                                    <!-- <div class="input-field col s4">
                                      <select id="doctorInput" name="doctor"class="validate">
                                      </select>
                                  </div> -->
                                        ...
                                        <div class="form-group">
                                            <div class="input-group date" id="datetimepicker3"
                                                ...
                                                <input class="form-control" type="time" id="hora" name="hora"
                                                    value="08:00" id="eventTimeInput">
                                                <label for="eventTimeInput"></label>
                                            </div>
                                            <!--PARA HORA CON JQUERY-->
                                            <!--input type="text" name="" id="picker" class="form-control"-->
                                            <!--FIN HORA CON JQUERY-->
                                        </div>
                                    </div>
                                </div>
