...
<body>
    ...
    <div id="navSidebar" class="sidebarNav">
        ...
        <a href="./doctores"><i class="fas fa-user-md"></i> Doctores</a>
      ...
      <div id="mainNav">
          <!--NAV DE PRUEBA-->
            <nav class="navbar navbar-expand-lg navbar-dark" style="background: #51034f;">
                    <button id="kk"class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
                      <span class="navbar-toggler-icon"></span>
                    </button>
                    <a class="navbar-brand" href="./home">
                      <img src="../img/logo_utp_1_300.jpg" width="30" height="30" class="d-inline-block align-top" alt="" style="border-radius:160px;"> 
                      Clínica UTP
                    </a>
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li class="nav-item active">
                          <a class="nav-link" href="./home"><i class="fa fa-fw fa-home"></i> Inicio <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="./calendario-pacientes"><i class="far fa-calendar-alt"></i> Calendario</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#" onclick="openNav()">Más <i class="far fa-caret-square-down" onclick="openNav()"></i></a>
                        </li>
                      </ul>
                      <div class="form-inline my-2 my-lg-0">
                        ...
                        <a href="./profile">
                          <img src="<?php echo '../'.$user->getFoto();?>" width="30" height="30" class="d-inline-block align-top" alt="" style="border-radius:160px;">
                        </a>
                      </div>
                    </div>
                  </nav>
